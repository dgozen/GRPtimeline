...
import ButtonArrowSmall from '../component/Buttons/ButtonArrowSmall/ButtonArrowSmall';
import InformationBoxLayout from '../component/InformationBoxLayout/InformationBoxLayout';
	...
	return (
		<div>
			...
			<div className={style.container}>
				...
				<div className={style.backdrop}>{showForm ? <Backdrop /> : null}</div>
